...
func (_IGatewayEVM *IGatewayEVMTransactor) Deposit0(opts *bind.TransactOpts, receiver common.Address, amount *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "deposit0", receiver, amount, revertOptions)
}

// Deposit0 is a paid mutator transaction binding the contract method 0x282906ed.
//
// Solidity: function deposit(address receiver, uint256 amount, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMSession) Deposit0(receiver common.Address, amount *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Deposit0(&_IGatewayEVM.TransactOpts, receiver, amount, revertOptions)
}

// Deposit0 is a paid mutator transaction binding the contract method 0x282906ed.
//
// Solidity: function deposit(address receiver, uint256 amount, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) Deposit0(receiver common.Address, amount *big.Int, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Deposit0(&_IGatewayEVM.TransactOpts, receiver, amount, revertOptions)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) Deposit1(opts *bind.TransactOpts, receiver common.Address, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "deposit1", receiver, revertOptions)
}

// Deposit1 is a paid mutator transaction binding the contract method 0x726ac97c.
//
// Solidity: function deposit(address receiver, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMSession) Deposit1(receiver common.Address, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Deposit1(&_IGatewayEVM.TransactOpts, receiver, revertOptions)
}

// Deposit1 is a paid mutator transaction binding the contract method 0x726ac97c.
//
// Solidity: function deposit(address receiver, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) Deposit1(receiver common.Address, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Deposit1(&_IGatewayEVM.TransactOpts, receiver, revertOptions)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) DepositAndCall(opts *bind.TransactOpts, receiver common.Address, amount *big.Int, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "depositAndCall", receiver, amount, payload, revertOptions)
}

// DepositAndCall is a paid mutator transaction binding the contract method 0x397e375c.
//
// Solidity: function depositAndCall(address receiver, uint256 amount, bytes payload, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMSession) DepositAndCall(receiver common.Address, amount *big.Int, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.DepositAndCall(&_IGatewayEVM.TransactOpts, receiver, amount, payload, revertOptions)
}

// DepositAndCall is a paid mutator transaction binding the contract method 0x397e375c.
//
// Solidity: function depositAndCall(address receiver, uint256 amount, bytes payload, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) DepositAndCall(receiver common.Address, amount *big.Int, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.DepositAndCall(&_IGatewayEVM.TransactOpts, receiver, amount, payload, revertOptions)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) DepositAndCall1(opts *bind.TransactOpts, receiver common.Address, amount *big.Int, asset common.Address, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "depositAndCall1", receiver, amount, asset, payload, revertOptions)
}

// DepositAndCall1 is a paid mutator transaction binding the contract method 0xd09e3b78.
//
// Solidity: function depositAndCall(address receiver, uint256 amount, address asset, bytes payload, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMSession) DepositAndCall1(receiver common.Address, amount *big.Int, asset common.Address, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.DepositAndCall1(&_IGatewayEVM.TransactOpts, receiver, amount, asset, payload, revertOptions)
}

// DepositAndCall1 is a paid mutator transaction binding the contract method 0xd09e3b78.
//
// Solidity: function depositAndCall(address receiver, uint256 amount, address asset, bytes payload, (address,bool,address,bytes,uint256) revertOptions) payable returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) DepositAndCall1(receiver common.Address, amount *big.Int, asset common.Address, payload []byte, revertOptions RevertOptions) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.DepositAndCall1(&_IGatewayEVM.TransactOpts, receiver, amount, asset, payload, revertOptions)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) Execute(opts *bind.TransactOpts, messageContext MessageContext, destination common.Address, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "execute", messageContext, destination, data)
}

// Execute is a paid mutator transaction binding the contract method 0x38e22527.
//
// Solidity: function execute((address) messageContext, address destination, bytes data) payable returns(bytes)
func (_IGatewayEVM *IGatewayEVMSession) Execute(messageContext MessageContext, destination common.Address, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Execute(&_IGatewayEVM.TransactOpts, messageContext, destination, data)
}

// Execute is a paid mutator transaction binding the contract method 0x38e22527.
//
// Solidity: function execute((address) messageContext, address destination, bytes data) payable returns(bytes)
func (_IGatewayEVM *IGatewayEVMTransactorSession) Execute(messageContext MessageContext, destination common.Address, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.Execute(&_IGatewayEVM.TransactOpts, messageContext, destination, data)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) ExecuteRevert(opts *bind.TransactOpts, destination common.Address, data []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "executeRevert", destination, data, revertContext)
}

// ExecuteRevert is a paid mutator transaction binding the contract method 0xcb7ba8e5.
//
// Solidity: function executeRevert(address destination, bytes data, (address,address,uint256,bytes) revertContext) payable returns()
func (_IGatewayEVM *IGatewayEVMSession) ExecuteRevert(destination common.Address, data []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.ExecuteRevert(&_IGatewayEVM.TransactOpts, destination, data, revertContext)
}

// ExecuteRevert is a paid mutator transaction binding the contract method 0xcb7ba8e5.
//
// Solidity: function executeRevert(address destination, bytes data, (address,address,uint256,bytes) revertContext) payable returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) ExecuteRevert(destination common.Address, data []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.ExecuteRevert(&_IGatewayEVM.TransactOpts, destination, data, revertContext)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) ExecuteWithERC20(opts *bind.TransactOpts, messageContext MessageContext, token common.Address, to common.Address, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "executeWithERC20", messageContext, token, to, amount, data)
}

// ExecuteWithERC20 is a paid mutator transaction binding the contract method 0x7bbe9afa.
//
// Solidity: function executeWithERC20((address) messageContext, address token, address to, uint256 amount, bytes data) returns()
func (_IGatewayEVM *IGatewayEVMSession) ExecuteWithERC20(messageContext MessageContext, token common.Address, to common.Address, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.ExecuteWithERC20(&_IGatewayEVM.TransactOpts, messageContext, token, to, amount, data)
}

// ExecuteWithERC20 is a paid mutator transaction binding the contract method 0x7bbe9afa.
//
// Solidity: function executeWithERC20((address) messageContext, address token, address to, uint256 amount, bytes data) returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) ExecuteWithERC20(messageContext MessageContext, token common.Address, to common.Address, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.ExecuteWithERC20(&_IGatewayEVM.TransactOpts, messageContext, token, to, amount, data)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) RevertWithERC20(opts *bind.TransactOpts, token common.Address, to common.Address, amount *big.Int, data []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "revertWithERC20", token, to, amount, data, revertContext)
}

// RevertWithERC20 is a paid mutator transaction binding the contract method 0xaa0c0fc1.
//
// Solidity: function revertWithERC20(address token, address to, uint256 amount, bytes data, (address,address,uint256,bytes) revertContext) returns()
func (_IGatewayEVM *IGatewayEVMSession) RevertWithERC20(token common.Address, to common.Address, amount *big.Int, data []byte, revertContext RevertContext) (*types.Transaction, error) {
...
//
// Solidity: function revertWithERC20(address token, address to, uint256 amount, bytes data, (address,address,uint256,bytes) revertContext) returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) RevertWithERC20(token common.Address, to common.Address, amount *big.Int, data []byte, revertContext RevertContext) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.RevertWithERC20(&_IGatewayEVM.TransactOpts, token, to, amount, data, revertContext)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) SetDepositAllowedAsset(opts *bind.TransactOpts, asset common.Address, allowed bool) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "setDepositAllowedAsset", asset, allowed)
}

// SetDepositAllowedAsset is a paid mutator transaction binding the contract method 0x4f27eb2a.
//
// Solidity: function setDepositAllowedAsset(address asset, bool allowed) returns()
func (_IGatewayEVM *IGatewayEVMSession) SetDepositAllowedAsset(asset common.Address, allowed bool) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.SetDepositAllowedAsset(&_IGatewayEVM.TransactOpts, asset, allowed)
}

// SetDepositAllowedAsset is a paid mutator transaction binding the contract method 0x4f27eb2a.
//
// Solidity: function setDepositAllowedAsset(address asset, bool allowed) returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) SetDepositAllowedAsset(asset common.Address, allowed bool) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.SetDepositAllowedAsset(&_IGatewayEVM.TransactOpts, asset, allowed)
}
...
func (_IGatewayEVM *IGatewayEVMTransactor) SetDepositPaused(opts *bind.TransactOpts, paused bool) (*types.Transaction, error) {
	return _IGatewayEVM.contract.Transact(opts, "setDepositPaused", paused)
}

// SetDepositPaused is a paid mutator transaction binding the contract method 0x543f66a4.
//
// Solidity: function setDepositPaused(bool paused) returns()
func (_IGatewayEVM *IGatewayEVMSession) SetDepositPaused(paused bool) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.SetDepositPaused(&_IGatewayEVM.TransactOpts, paused)
}

// SetDepositPaused is a paid mutator transaction binding the contract method 0x543f66a4.
//
// Solidity: function setDepositPaused(bool paused) returns()
func (_IGatewayEVM *IGatewayEVMTransactorSession) SetDepositPaused(paused bool) (*types.Transaction, error) {
	return _IGatewayEVM.Contract.SetDepositPaused(&_IGatewayEVM.TransactOpts, paused)
}
...
type IGatewayEVMDeposited struct {
	Sender        common.Address
	Receiver      common.Address
	Amount        *big.Int
	Asset         common.Address
...
type IGatewayEVMDepositedAndCalledIterator struct {
	Event *IGatewayEVMDepositedAndCalled // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IGatewayEVMDepositedAndCalledIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IGatewayEVMDepositedAndCalled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IGatewayEVMDepositedAndCalledIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IGatewayEVMDepositedAndCalledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IGatewayEVMDepositedAndCalled represents a DepositedAndCalled event raised by the IGatewayEVM contract.
type IGatewayEVMDepositedAndCalled struct {
	Sender        common.Address
	Receiver      common.Address
	Amount        *big.Int
	Asset         common.Address
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterDepositedAndCalled(opts *bind.FilterOpts, sender []common.Address, receiver []common.Address) (*IGatewayEVMDepositedAndCalledIterator, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "DepositedAndCalled", senderRule, receiverRule)
	if err != nil {
		return nil, err
	}
	return &IGatewayEVMDepositedAndCalledIterator{contract: _IGatewayEVM.contract, event: "DepositedAndCalled", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DepositedAndCalled(address indexed sender, address indexed receiver, uint256 amount, address asset, bytes payload, (address,bool,address,bytes,uint256) revertOptions)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchDepositedAndCalled(opts *bind.WatchOpts, sink chan<- *IGatewayEVMDepositedAndCalled, sender []common.Address, receiver []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "DepositedAndCalled", senderRule, receiverRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IGatewayEVMDepositedAndCalled)
				if err := _IGatewayEVM.contract.UnpackLog(event, "DepositedAndCalled", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DepositedAndCalled(address indexed sender, address indexed receiver, uint256 amount, address asset, bytes payload, (address,bool,address,bytes,uint256) revertOptions)
func (_IGatewayEVM *IGatewayEVMFilterer) ParseDepositedAndCalled(log types.Log) (*IGatewayEVMDepositedAndCalled, error) {
	event := new(IGatewayEVMDepositedAndCalled)
	if err := _IGatewayEVM.contract.UnpackLog(event, "DepositedAndCalled", log); err != nil {
		return nil, err
	}
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterReverted(opts *bind.FilterOpts, to []common.Address, token []common.Address) (*IGatewayEVMRevertedIterator, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "Reverted", toRule, tokenRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Reverted(address indexed to, address indexed token, uint256 amount, bytes data, (address,address,uint256,bytes) revertContext)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchReverted(opts *bind.WatchOpts, sink chan<- *IGatewayEVMReverted, to []common.Address, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "Reverted", toRule, tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// IGatewayEVMUpdatedAdditionalActionFeeIterator is returned from FilterUpdatedAdditionalActionFee and is used to iterate over the raw logs and unpacked data for UpdatedAdditionalActionFee events raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedAdditionalActionFeeIterator struct {
	Event *IGatewayEVMUpdatedAdditionalActionFee // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IGatewayEVMUpdatedAdditionalActionFeeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IGatewayEVMUpdatedAdditionalActionFee)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IGatewayEVMUpdatedAdditionalActionFeeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IGatewayEVMUpdatedAdditionalActionFeeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IGatewayEVMUpdatedAdditionalActionFee represents a UpdatedAdditionalActionFee event raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedAdditionalActionFee struct {
	OldFeeWei *big.Int
	NewFeeWei *big.Int
	Raw       types.Log // Blockchain specific contextual infos
}
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterUpdatedAdditionalActionFee(opts *bind.FilterOpts) (*IGatewayEVMUpdatedAdditionalActionFeeIterator, error) {

	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "UpdatedAdditionalActionFee")
	if err != nil {
		return nil, err
	}
	return &IGatewayEVMUpdatedAdditionalActionFeeIterator{contract: _IGatewayEVM.contract, event: "UpdatedAdditionalActionFee", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedAdditionalActionFee(uint256 oldFeeWei, uint256 newFeeWei)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchUpdatedAdditionalActionFee(opts *bind.WatchOpts, sink chan<- *IGatewayEVMUpdatedAdditionalActionFee) (event.Subscription, error) {

	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "UpdatedAdditionalActionFee")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IGatewayEVMUpdatedAdditionalActionFee)
				if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedAdditionalActionFee", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedAdditionalActionFee(uint256 oldFeeWei, uint256 newFeeWei)
func (_IGatewayEVM *IGatewayEVMFilterer) ParseUpdatedAdditionalActionFee(log types.Log) (*IGatewayEVMUpdatedAdditionalActionFee, error) {
	event := new(IGatewayEVMUpdatedAdditionalActionFee)
	if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedAdditionalActionFee", log); err != nil {
		return nil, err
	}
...
// IGatewayEVMUpdatedDepositAllowedAssetIterator is returned from FilterUpdatedDepositAllowedAsset and is used to iterate over the raw logs and unpacked data for UpdatedDepositAllowedAsset events raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedDepositAllowedAssetIterator struct {
	Event *IGatewayEVMUpdatedDepositAllowedAsset // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IGatewayEVMUpdatedDepositAllowedAssetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IGatewayEVMUpdatedDepositAllowedAsset)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IGatewayEVMUpdatedDepositAllowedAssetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IGatewayEVMUpdatedDepositAllowedAssetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IGatewayEVMUpdatedDepositAllowedAsset represents a UpdatedDepositAllowedAsset event raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedDepositAllowedAsset struct {
	Asset   common.Address
	Allowed bool
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterUpdatedDepositAllowedAsset(opts *bind.FilterOpts, asset []common.Address) (*IGatewayEVMUpdatedDepositAllowedAssetIterator, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "UpdatedDepositAllowedAsset", assetRule)
	if err != nil {
		return nil, err
	}
	return &IGatewayEVMUpdatedDepositAllowedAssetIterator{contract: _IGatewayEVM.contract, event: "UpdatedDepositAllowedAsset", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedDepositAllowedAsset(address indexed asset, bool allowed)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchUpdatedDepositAllowedAsset(opts *bind.WatchOpts, sink chan<- *IGatewayEVMUpdatedDepositAllowedAsset, asset []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "UpdatedDepositAllowedAsset", assetRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IGatewayEVMUpdatedDepositAllowedAsset)
				if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedDepositAllowedAsset", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedDepositAllowedAsset(address indexed asset, bool allowed)
func (_IGatewayEVM *IGatewayEVMFilterer) ParseUpdatedDepositAllowedAsset(log types.Log) (*IGatewayEVMUpdatedDepositAllowedAsset, error) {
	event := new(IGatewayEVMUpdatedDepositAllowedAsset)
	if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedDepositAllowedAsset", log); err != nil {
		return nil, err
	}
...
// IGatewayEVMUpdatedDepositPausedIterator is returned from FilterUpdatedDepositPaused and is used to iterate over the raw logs and unpacked data for UpdatedDepositPaused events raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedDepositPausedIterator struct {
	Event *IGatewayEVMUpdatedDepositPaused // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IGatewayEVMUpdatedDepositPausedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IGatewayEVMUpdatedDepositPaused)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IGatewayEVMUpdatedDepositPausedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IGatewayEVMUpdatedDepositPausedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IGatewayEVMUpdatedDepositPaused represents a UpdatedDepositPaused event raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedDepositPaused struct {
	Paused bool
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterUpdatedDepositPaused(opts *bind.FilterOpts) (*IGatewayEVMUpdatedDepositPausedIterator, error) {

	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "UpdatedDepositPaused")
	if err != nil {
		return nil, err
	}
	return &IGatewayEVMUpdatedDepositPausedIterator{contract: _IGatewayEVM.contract, event: "UpdatedDepositPaused", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedDepositPaused(bool paused)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchUpdatedDepositPaused(opts *bind.WatchOpts, sink chan<- *IGatewayEVMUpdatedDepositPaused) (event.Subscription, error) {

	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "UpdatedDepositPaused")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IGatewayEVMUpdatedDepositPaused)
				if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedDepositPaused", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedDepositPaused(bool paused)
func (_IGatewayEVM *IGatewayEVMFilterer) ParseUpdatedDepositPaused(log types.Log) (*IGatewayEVMUpdatedDepositPaused, error) {
	event := new(IGatewayEVMUpdatedDepositPaused)
	if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedDepositPaused", log); err != nil {
		return nil, err
	}
...
type IGatewayEVMUpdatedGatewayTSSAddressIterator struct {
	Event *IGatewayEVMUpdatedGatewayTSSAddress // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IGatewayEVMUpdatedGatewayTSSAddressIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IGatewayEVMUpdatedGatewayTSSAddress)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IGatewayEVMUpdatedGatewayTSSAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IGatewayEVMUpdatedGatewayTSSAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IGatewayEVMUpdatedGatewayTSSAddress represents a UpdatedGatewayTSSAddress event raised by the IGatewayEVM contract.
type IGatewayEVMUpdatedGatewayTSSAddress struct {
...
func (_IGatewayEVM *IGatewayEVMFilterer) FilterUpdatedGatewayTSSAddress(opts *bind.FilterOpts) (*IGatewayEVMUpdatedGatewayTSSAddressIterator, error) {

	logs, sub, err := _IGatewayEVM.contract.FilterLogs(opts, "UpdatedGatewayTSSAddress")
	if err != nil {
		return nil, err
	}
	return &IGatewayEVMUpdatedGatewayTSSAddressIterator{contract: _IGatewayEVM.contract, event: "UpdatedGatewayTSSAddress", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UpdatedGatewayTSSAddress(address oldTSSAddress, address newTSSAddress)
func (_IGatewayEVM *IGatewayEVMFilterer) WatchUpdatedGatewayTSSAddress(opts *bind.WatchOpts, sink chan<- *IGatewayEVMUpdatedGatewayTSSAddress) (event.Subscription, error) {

	logs, sub, err := _IGatewayEVM.contract.WatchLogs(opts, "UpdatedGatewayTSSAddress")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IGatewayEVMUpdatedGatewayTSSAddress)
				if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedGatewayTSSAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UpdatedGatewayTSSAddress(address oldTSSAddress, address newTSSAddress)
func (_IGatewayEVM *IGatewayEVMFilterer) ParseUpdatedGatewayTSSAddress(log types.Log) (*IGatewayEVMUpdatedGatewayTSSAddress, error) {
	event := new(IGatewayEVMUpdatedGatewayTSSAddress)
	if err := _IGatewayEVM.contract.UnpackLog(event, "UpdatedGatewayTSSAddress", log); err != nil {
		return nil, err
	}
