...
func (_IERC20Custody *IERC20CustodyTransactor) RefundStrandedFunds(opts *bind.TransactOpts, to common.Address, token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20Custody.contract.Transact(opts, "refundStrandedFunds", to, token, amount)
}

// RefundStrandedFunds is a paid mutator transaction binding the contract method 0x3e1b9644.
//
// Solidity: function refundStrandedFunds(address to, address token, uint256 amount) returns()
func (_IERC20Custody *IERC20CustodySession) RefundStrandedFunds(to common.Address, token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20Custody.Contract.RefundStrandedFunds(&_IERC20Custody.TransactOpts, to, token, amount)
}

// RefundStrandedFunds is a paid mutator transaction binding the contract method 0x3e1b9644.
//
// Solidity: function refundStrandedFunds(address to, address token, uint256 amount) returns()
func (_IERC20Custody *IERC20CustodyTransactorSession) RefundStrandedFunds(to common.Address, token common.Address, amount *big.Int) (*types.Transaction, error) {
	return _IERC20Custody.Contract.RefundStrandedFunds(&_IERC20Custody.TransactOpts, to, token, amount)
}
...
// IERC20CustodyStrandedFundsRefundedIterator is returned from FilterStrandedFundsRefunded and is used to iterate over the raw logs and unpacked data for StrandedFundsRefunded events raised by the IERC20Custody contract.
type IERC20CustodyStrandedFundsRefundedIterator struct {
	Event *IERC20CustodyStrandedFundsRefunded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IERC20CustodyStrandedFundsRefundedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IERC20CustodyStrandedFundsRefunded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IERC20CustodyStrandedFundsRefundedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IERC20CustodyStrandedFundsRefundedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IERC20CustodyStrandedFundsRefunded represents a StrandedFundsRefunded event raised by the IERC20Custody contract.
type IERC20CustodyStrandedFundsRefunded struct {
	To     common.Address
...
func (_IERC20Custody *IERC20CustodyFilterer) FilterStrandedFundsRefunded(opts *bind.FilterOpts, to []common.Address, token []common.Address) (*IERC20CustodyStrandedFundsRefundedIterator, error) {
	...
	logs, sub, err := _IERC20Custody.contract.FilterLogs(opts, "StrandedFundsRefunded", toRule, tokenRule)
	if err != nil {
		return nil, err
	}
	return &IERC20CustodyStrandedFundsRefundedIterator{contract: _IERC20Custody.contract, event: "StrandedFundsRefunded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StrandedFundsRefunded(address indexed to, address indexed token, uint256 amount)
func (_IERC20Custody *IERC20CustodyFilterer) WatchStrandedFundsRefunded(opts *bind.WatchOpts, sink chan<- *IERC20CustodyStrandedFundsRefunded, to []common.Address, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IERC20Custody.contract.WatchLogs(opts, "StrandedFundsRefunded", toRule, tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IERC20CustodyStrandedFundsRefunded)
				if err := _IERC20Custody.contract.UnpackLog(event, "StrandedFundsRefunded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StrandedFundsRefunded(address indexed to, address indexed token, uint256 amount)
func (_IERC20Custody *IERC20CustodyFilterer) ParseStrandedFundsRefunded(log types.Log) (*IERC20CustodyStrandedFundsRefunded, error) {
	event := new(IERC20CustodyStrandedFundsRefunded)
	if err := _IERC20Custody.contract.UnpackLog(event, "StrandedFundsRefunded", log); err != nil {
		return nil, err
	}
